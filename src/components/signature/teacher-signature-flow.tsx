...
export interface TeacherSignatureSessionData {
    teacher: {
        id: string
        name: string
        email: string
    ...
    signed?: boolean
    missedSessions?: TeacherMissedSession[]
}

export interface TeacherMissedSession {
    id: string
    title: string | null
...
export interface TeacherSignatureFlowProps {
    sessionData: TeacherSignatureSessionData
    onSubmitSignature: (signatureData: string) => Promise<{ success: boolean; error?: string }>
...
export function TeacherSignatureFlow({
    sessionData,
    onSubmitSignature,
    onSignMissedSession,
    translations = {}
}: TeacherSignatureFlowProps) {
    ...
    const [missedSessions, setMissedSessions] = useState<TeacherMissedSession[]>(sessionData.missedSessions || [])
    ...
    const handleSignMissedSession = async (session: TeacherMissedSession) => {
                    ...
                    <CardContent className="space-y-6">
                        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                            <p className="text-sm text-emerald-900">
                                <strong>{t.teacher}:</strong> {sessionData.teacher.name}
                            </p>
                            <p className="text-sm text-emerald-900">
